//To run: gcc fakeSYN.c && sudo ./a.out
...
//Calculate the TCP header checksum of a string
...
int main(int argc, char **argv) {
  ...
  //Now calculate the check sum for the IP header check field
  ...
  //Now calculate the checksum for the TCP header
